...
export const metadata: Metadata = {
  ...
  title: {
    default: '3D.GRYZ – 3D маскоты и визуализация для брендов | Москва',
    template: '%s | 3D.GRYZ',
  },
  description: 'Студия 3D визуализации в Москве. Создаем маскоты, персонажи и анимацию с AI-ускорением. Бесплатный концепт за 1 час. От 150 000 ₽ за проект.',
  keywords: [
    '3D визуализация',
    '3D моделирование',
    '3D персонаж',
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: '3D.GRYZ',
    title: '3D.GRYZ – 3D маскоты и визуализация для брендов | Москва',
    description: 'Студия 3D визуализации в Москве. Создаем маскоты, персонажи и анимацию с AI-ускорением. Бесплатный концепт за 1 час.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
