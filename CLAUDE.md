...
**Нерешённое:**
- `og-image.jpg` отсутствует в /public/ (OG-image в метаданных ссылается на несуществующий файл)
- Домен зарегистрирован 14 января 2026 (28 дней назад) — песочница Google, нужно время
- Нет бэклинков — критически важно получить ссылки с авторитетных сайтов
- DNS на reg.ru → Vercel (216.198.79.1) — решено: оставляем Vercel, GitHub Actions деплой удалён
